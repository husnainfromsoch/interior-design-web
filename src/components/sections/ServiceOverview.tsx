      ...
      <div className="mx-auto grid max-w-[1320px] grid-cols-1 gap-16 px-6 lg:grid-cols-[0.85fr_1.15fr] lg:gap-12 lg:px-8">
        <div className="reveal-left lg:sticky lg:top-28 lg:self-start">
          <div className="relative">
            ...
            {secondaryImage && (
              <div className="absolute -bottom-10 -right-6 hidden aspect-[4/5] w-[45%] overflow-hidden rounded-xl border-4 border-bv-background shadow-[0_16px_36px_-14px_rgba(46,42,37,0.4)] sm:block">
                <Image
                  src={secondaryImage}
                  alt={`${title} detail`}
                  fill
        ...
        <div className="reveal-right">
          ...
          <TextBlockAnimation blockColor="#98583F" duration={0.7} stagger={0.08}>
            <h2 className="max-w-lg font-bv-heading text-[24px] leading-snug sm:text-[28px]">
              {t("overviewHeading")}
            </h2>
          </TextBlockAnimation>
          ...
          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2">
            {highlights.map((point, i) => (
              <div
                key={point.title}
                className="reveal-scale rounded-2xl border border-bv-line/70 bg-bv-background p-6 shadow-[0_2px_10px_-4px_rgba(46,42,37,0.08)] transition-all duration-200 hover:-translate-y-1 hover:border-bv-accent/40 hover:shadow-[0_16px_32px_-16px_rgba(46,42,37,0.25)]"
