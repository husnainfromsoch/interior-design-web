...
const fieldClass =
  "mt-2 h-[56px] w-full rounded-[14px] border border-bv-field-border/50 bg-bv-surface/60 px-4 text-[16px] text-bv-ink outline-none transition-all duration-200 placeholder:text-bv-muted/60 hover:border-bv-field-border focus-visible:border-bv-accent focus-visible:bg-bv-white focus-visible:ring-4 focus-visible:ring-bv-accent/10 aria-[invalid=true]:border-bv-error";
const textareaClass =
  "mt-2 w-full resize-none rounded-[14px] border border-bv-field-border/50 bg-bv-surface/60 px-4 py-4 text-[16px] text-bv-ink outline-none transition-all duration-200 placeholder:text-bv-muted/60 hover:border-bv-field-border focus-visible:border-bv-accent focus-visible:bg-bv-white focus-visible:ring-4 focus-visible:ring-bv-accent/10";
...
export default function EnquiryForm({ id = "project-enquiry" }: { id?: string }) {
  ...
  if (status === "success") {
    return (
      <div className="bg-bv-surface px-4 py-16 sm:px-10 md:py-[96px] lg:px-16 lg:py-[128px]" style={{ scrollMarginTop: "104px" }}>
        <div
          id={id}
          className="mx-auto flex w-full max-w-[1320px] flex-col items-center gap-5 rounded-[20px] border border-bv-line bg-bv-background px-8 py-14 text-center"
        >
    ...
    <div id={id} className="bg-bv-surface px-4 py-16 sm:px-10 md:py-[96px] lg:px-16 lg:py-[128px]" style={{ scrollMarginTop: "104px" }}>
      <div className="mx-auto grid w-full max-w-[1320px] grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-10">
        <div className="lg:col-span-5">
          <div className="relative overflow-hidden rounded-[28px] bg-bv-ink p-8 text-bv-white sm:p-10 lg:sticky lg:top-28 lg:p-12">
            <Image
            ...
            <div className="relative">
              <span className="font-[var(--font-bv-body)] text-[12px] font-semibold uppercase tracking-[0.16em] text-bv-white/60">
                {t("eyebrow")}
              </span>
              <h2 className="mt-4 font-[var(--font-bv-heading)] text-[34px] font-medium leading-[1.1] sm:text-[42px] lg:text-[48px]">
                {t("heading")}
              </h2>
              ...
              <a
                ...
                className="mt-6 inline-flex h-[52px] items-center gap-2 rounded-full border border-bv-white/30 px-7 text-sm font-semibold tracking-[0.02em] transition-all duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] hover:bg-bv-white hover:text-bv-ink active:scale-[0.98] motion-reduce:transition-none"
              >
        ...
        <form
          ...
          className="rounded-[28px] border border-bv-line bg-bv-background p-6 shadow-[0_32px_64px_-40px_rgba(51,46,43,0.35)] sm:p-10 lg:col-span-7 lg:p-12"
          noValidate
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              <div>
                ...
                <select id="ef-service" name="service" defaultValue="" className={fieldClass}>
