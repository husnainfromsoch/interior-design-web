...
const StatCard = ({ value, label }: Stat) => (
  <Card className="rounded-xl border-champagne/20 bg-ivory/[0.04] text-center">
...
const StickyTestimonialCard = ({
  ...
  return (
    <motion.div className="sticky w-full" style={{ top: `${20 + index * 24}px` }}>
      <div className="flex h-auto w-full flex-col rounded-2xl border border-ivory/10 bg-soft-black p-6 shadow-[0_20px_40px_-20px_rgba(0,0,0,0.6)]">
    ...
    <section className={cn("w-full bg-soft-black py-20 text-ivory md:py-28", className)}>
      <div className="mx-auto grid max-w-[1180px] grid-cols-1 items-start gap-12 px-6 lg:grid-cols-2 lg:gap-20 lg:px-8">
        <div className="flex flex-col gap-6 lg:sticky lg:top-20">
          <div className="inline-flex items-center gap-2 self-start rounded-full border border-ivory/10 bg-ivory/[0.04] px-3 py-1 text-sm">
